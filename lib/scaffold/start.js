...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for litecoinzd is necessary for this upgrade with the "reindex=1" litecoinz.conf option. \n' +
                 'There are changes necessary in both litecoinz.conf and bitcore-node.json. \n\n' +
                 'To upgrade please see the details below and documentation at: \n' +
                 'https://github.com/bitpay/bitcore-node/blob/litecoinzd/docs/upgrade.md \n');
