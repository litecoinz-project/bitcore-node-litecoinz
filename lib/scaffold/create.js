...
var BASE_PACKAGE = {
  description: 'A full LitcoinZ node build with Bitcore',
  repository: 'https://github.com/user/project',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-litecoinz': 'litecoinz-project/bitcore-lib-litecoinz',
    'bitcore-node-litecoinz': 'litecoinz-project/bitcore-node-litecoinz'
  }
};
