...
npm install
```
**Note**: If you get a message about not being able to download bitcoin distribution, you'll need to compile litecoinzd from source, and setup your configuration to use that version.
...
```bash
mocha -w -R spec test/services/litecoinzd.unit.js
```
