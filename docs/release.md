...
Binaries for litecoinzd are distributed for convenience and built deterministically with Gitian, signatures for litecoinzd are located at the [gitian.sigs](https://github.com/bitpay/gitian.sigs) respository.
